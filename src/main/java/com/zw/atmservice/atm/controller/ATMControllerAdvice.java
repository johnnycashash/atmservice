...
public class ATMControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidPinException(InvalidPinException exception,
                                                                   WebRequest request) {
    ...
    @ExceptionHandler(AmountInDispensableException.class)
    public ResponseEntity<ErrorResponse> handleAmountInDispensableException(AmountInDispensableException exception,
                                                                            WebRequest request) {
